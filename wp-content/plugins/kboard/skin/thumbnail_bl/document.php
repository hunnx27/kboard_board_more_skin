<div id="kboard-document">
	<div id="kboard-thumbnail-document" class="bl_kboard_detail">
		<div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
			<div class="bl_kboard_detail_head">
				<div class="kboard-title bl_kboard_detail_title" itemprop="name">
				...
				<div class="kboard-detail">
					...
					<?php endfor?>
					<?php endif?>
					<div class="detail-attr detail-writer bl_kboard_detail_writer">
					...
					<div class="detail-attr detail-date bl_kboard_detail_date">
						<div class="detail-name">
							<!--<?php echo __('Date', 'kboard')?>-->
		...
		<div class="kboard-thumbnail-poweredby" style="opacity:0;">
